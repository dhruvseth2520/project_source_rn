              ...
              <View style={styles.loadingContainer}>
                ...
                <ActivityIndicator size="large" color="#1AA2B0" style={{top: 30}}></ActivityIndicator>
                  ...
                  <Text style={styles.title}>Finish setting up your profile</Text>
                        <Swiper style={styles.wrapper} loop={false} paginationStyle={{bottom: 20}} dot={dot} activeDot={activeDot}>
                                  ...
                                  <FlatList
                                    ...
                                    renderItem={({ item }) => (
                                      <View style={styles.imageHolder}>
                                        ...
                                        <Image source={{uri: item.uri}} style={{borderRadius: 10, width: windowWidth * 0.33, height: 0.30 * windowHeight}} />
                                      </View>
                                    )}
                                  />
                                </ScrollView>
