...
import { ScrollView, View, Image, Text, StyleSheet, FlatList } from 'react-native';
...
const VenuePromotersScreen = ({ route }) => {
  ...
  return (
    <ScrollView style={styles.background}>
      ...
      <Text style={styles.subTitle}>Top Promoters in your area</Text>
      ...
      <FlatList horizontal
        ...
        renderItem={({ item }) => {
          return <PromoterCard name={item.firstName} image={item.profileImg}></PromoterCard>
        }}
      />
